...
public class ScannerTest {
	...
	@Test
	public void selfTrial1() throws IllegalCharException, IllegalNumberException {
		String input = "   dudhoduaefhao    12423";
		...
		checkNext(scanner,INT_LIT);
	}
	
	@Test
	public void selfTrial2() throws IllegalCharException, IllegalNumberException {
		String input = "<<<<<<<<<<==";
		Scanner scanner = new Scanner(input);
		thrown.expect(IllegalCharException.class);
		scanner.scan();		
	...
	@Test
	public void selfTrial3() throws IllegalCharException, IllegalNumberException {
		String input = "0x0011EADB";
		Scanner scanner = new Scanner(input);
		scanner.scan();
		if (doPrint) {
			System.out.println(input);
...
//		checkNext(scanner,IDENT);
	...
	@Test
	public void selfTrial4() throws IllegalCharException, IllegalNumberException {
		String input = "boolean b != true";
		Scanner scanner = new Scanner(input);
		scanner.scan();
		...
		checkNext(scanner,KW_BOOLEAN);
		checkNext(scanner,IDENT);
		checkNext(scanner,NOTEQUAL);
		checkNext(scanner,KW_TRUE);
		
	}
	
	@Test
	public void selfTrial5() throws IllegalCharException, IllegalNumberException {
		String input = "==-a;+<";
		Scanner scanner = new Scanner(input);
		scanner.scan();
		//thrown.expect(IllegalCharException.class);
		...
		checkNext(scanner,EQUAL);
		checkNext(scanner,MINUS);
		checkNext(scanner,IDENT);
		checkNext(scanner,SEMI);
		checkNext(scanner,PLUS);
		checkNext(scanner,LT);
	...
	@Test
	public void selfTrial6() throws IllegalCharException, IllegalNumberException {
		String input = "<=!>=/*fgfhf*/";
		Scanner scanner = new Scanner(input);
		scanner.scan();
		if (doPrint) {
		...
		checkNext(scanner,LE);
		checkNext(scanner,NOT);
		checkNext(scanner,GE);
	}
	
	@Test
	public void selfTrial7() throws IllegalCharException, IllegalNumberException {
		String input = "<- <-!==<=             >=\n";
		Scanner scanner = new Scanner (input);
		thrown.expect(IllegalCharException.class);
		scanner.scan();
	...
	@Test
	public void selfTrial8() throws IllegalCharException, IllegalNumberException {
		String input = "<- <-! ==<=             >=\n";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
	...
	@Test
	public void selfTrial9() throws IllegalCharException, IllegalNumberException {
		String input = "";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
		...
		checkNext(scanner,EOF);
	}
	
	@Test
	public void selfTrial10() throws IllegalCharException, IllegalNumberException {
		String input = "abc  != <-->;";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
		...
		checkNext(scanner,NOTEQUAL);
		checkNext(scanner,ASSIGN);
		checkNext(scanner,ARROW);
		checkNext(scanner,SEMI);
	}
	
	@Test
	public void selfTrial11() throws IllegalCharException, IllegalNumberException {
		String input = "abc  != <-|->;";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
		...
		checkNext(scanner,NOTEQUAL);
		checkNext(scanner,ASSIGN);
		checkNext(scanner,BARARROW);
		checkNext(scanner,SEMI);
	}
	
	@Test
	public void selfTrial12() throws IllegalCharException, IllegalNumberException {
		String input = "\n";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
	...
	@Test
	public void selfTrial13() throws IllegalCharException, IllegalNumberException {
		String input = "\n\r\t";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
	...
	@Test
	public void selfTrial14() throws IllegalCharException, IllegalNumberException {
		String input = "                                                 ";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
	...
	@Test
	public void selfTrial15() throws IllegalCharException, IllegalNumberException {
		String input = " Gosh! Such a hard , exhausting Assignment - 1";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
			System.out.println(input);
	...
	@Test
	public void selfTrial16() throws IllegalCharException, IllegalNumberException {
		String input = "\tdil\ntar\ravvf";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
	...
	@Test
	public void selfTrial17() throws IllegalCharException, IllegalNumberException {
		String input = "{/*Rolling in the deep*/}";
		Scanner scanner = new Scanner (input);
		scanner.scan();
		if (doPrint) {
			System.out.println(input);
		...
		checkNext(scanner,LBRACE);
		checkNext(scanner,RBRACE);
	}
